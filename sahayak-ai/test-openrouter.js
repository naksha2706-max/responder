/**
 * Test OpenRouter integration with Claude 3 Haiku
...
async function testOpenRouter() {
  ...
  try {
    const response = await fetch('https://openrouter.ai/api/v1/chat/completions', {
      ...
      body: JSON.stringify({
        ...
        messages: [
          ...
          { role: 'user', content: 'I am feeling stressed about my studies and some seniors are bothering me' }
        ],
        max_tokens: 1000,
        temperature: 0.3
      })
    ...
    console.log('\n🎯 Key fields:');
    console.log(`Response: ${parsed.response.substring(0, 100)}...`);
    console.log(`Ready to classify: ${parsed.readyToClassify}`);
